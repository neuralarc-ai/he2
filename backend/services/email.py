...
class EmailService:
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Helium— Let's Get Started "
...
<head>
  ...
  <title>Welcome to Neuralarc Helium</title>
  <style>
    body {{
...
<body>
  <div class="container">
    ...
    <h1>Welcome to Neuralarc Helium!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Neuralarc Helium — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the Helium community <span class="emoji">🌞</span></p>
...
Welcome to Helium — we're excited to have you on board!
...
Thanks again, and welcome to the Helium community 🌞
...
You received this email because you signed up for a Helium account."""
